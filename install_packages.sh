#!/usr/bin/bash
sudo pacman -Syy
sudo pacman -S xorg-xinit xorg-server ntfs-3g noto-fonts noto-fonts-emoji alsa-utils wireguard-tools openresolv wgcf viewnior aria2 yt-dlp python-brotli python-pip mpv htop p7zip xarchiver tealdeer ripgrep
